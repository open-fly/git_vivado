...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net CLK_200MM_N_1 [get_bd_ports CLK_200MM_N] [get_bd_pins DAQ_TOP/CLK_200M_N] [get_bd_pins MEM_TOP/c0_sys_clk_n]
  connect_bd_net -net CLK_200MM_P_1 [get_bd_ports CLK_200MM_P] [get_bd_pins DAQ_TOP/CLK_200M_P] [get_bd_pins MEM_TOP/c0_sys_clk_p]
